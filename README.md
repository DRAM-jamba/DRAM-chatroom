...
The app automatically creates a secure identity for each server you connect to, allowing you to join chat sessions without signing up.
...
- No account system
- Client-generated cryptographic identity
...
Anyone can run their own Quorthon server and clients can connect to any available one if they no the right adress.
...
1. [Download and install required dependancies](https://tauri.app/start/prerequisites/)
2. Clone repository
